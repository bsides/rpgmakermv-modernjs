(function (global, factory) {
    if (typeof define === "function" && define.amd) {
        define(['nw.gui'], factory);
    } else if (typeof exports !== "undefined") {
        factory(require('nw.gui'));
    } else {
        var mod = {
            exports: {}
        };
    ...
    */
    Utils.isNwjs = function () {
        return typeof require === 'function' && (typeof process === 'undefined' ? 'undefined' : _typeof(process)) === 'object';
    };
        ...
        if (type === '[object Object]' || type === '[object Array]') {
            ...
            for (var key in value) {
                if (value.hasOwnProperty(key) && !key.match(/^@./)) {
                    if (value[key] && _typeof(value[key]) === 'object') {
                        if (value[key]['@c']) {
    ...
    */
    ...
    Decrypter.extToEncryptExt = function (url) {
        ...
        if (ext === "ogg") encryptedExt = ".rpgmvo";else if (ext === "m4a") encryptedExt = ".rpgmvm";else if (ext === "png") encryptedExt = ".rpgmvp";else encryptedExt = ext;
